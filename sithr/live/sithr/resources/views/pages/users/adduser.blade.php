                    ...
                    <div class="row mb-4">
                        <div class="col-lg-4 col-sm-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" name="username" value="{{ old('username') }}" id="usernameValidate" placeholder="اسم المستخدم" required>
                                <small id="emailHelp" class="form-text text-muted">*مطلوب</small>
                            </div>
                            <!-- End of Form -->
                            <!-- Form -->
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input class="form-check-input" name="permission" type="checkbox" id="flexSwitchCheckChecked" {{ old('permission') ? 'checked' : '' }}>
                                    <input type="text" name="permission_num"  value="{{ old('permission_num') }}" placeholder="عدد الاذونات" class="hidden form-control">
                                </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="password" name="password" class="form-control" id="exampleInputIconPassword" placeholder="كلمة المرور" aria-label="Password" required>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control" id="exampleInputIconPassword" placeholder="تأكيد كلمة المرور" name="confirmpass" aria-label="Password" required>
                                    <span class="input-group-text" id="basic-addon3">
                                        <svg class="icon icon-xs text-gray-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd"></path></svg>
                                    </span>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input class="form-check-input" name="vacations" type="checkbox" id="flexSwitchCheckDefault" {{ old('vacations') ? 'checked' : '' }}>
                                    <input type="text" name="vacations_num" placeholder="عدد الاذونات" value="{{ old('vacations_num') }}" class="hidden form-control">
                                </div>
                                <small id="emailHelp" class="form-text text-muted">غير مطلوب</small>
                            </div>
                            <!-- End of Form -->
                        ...
                        <div class="col-lg-4 col-sm-6">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input data-datepicker="" name="birthdate" value="{{ old('birthdate') }}" class="form-control" id="birthday" type="text">
                                </div>
                                <small id="emailHelp" class="form-text text-muted">غير مطلوب</small>
                            </div>
                            <!-- End of Form -->
