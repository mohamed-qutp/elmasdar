...
<html  dir="rtl" lang="ar" class="dark" data-bs-theme="light">
  <head>
    ...
    <!-- title --><title>المصدر لتقنية المعلومات</title>
    <!-- Favicon --><link rel="shortcut icon" href="https://www.pxdraft.com/wrap/mombo/assets/img/favicon.ico">
    ...
    <link href="{{asset('assets/rtlcss/theme.css')}}" rel="stylesheet">
