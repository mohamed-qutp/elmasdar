@if(app()->getLocale() == 'ar')
  ...
  <section id="hero" class="hero bg-gray-100">
        ...
        <div class="row  justify-content-center section-heading">
                        ...
                        <h3 class="bg-primary-after after-50px pb-3 mb-3">{{ trans('solutions/byField/educational_institutions.solutionclassificationbasetitle') }}</h3>                       
                      </div>
                    </div>
            ...
            <div class="col-lg-12 col-xl-12">                         
                <p class="lead mb-3"><?php $str = htmlspecialchars_decode(trans('solutions/byField/educational_institutions.solutionclassificationonefeatures'));
                                          echo $str; ?></p>                                     
            </div>  
        </div>   
