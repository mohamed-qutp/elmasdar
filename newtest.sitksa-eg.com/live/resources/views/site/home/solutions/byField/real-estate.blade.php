@if(app()->getLocale() == 'ar')
  ...
  <section id="hero" class="hero bg-gray-100">
        ...
        <div class="row  justify-content-center section-heading">
                        ...
                        <h3 class="bg-primary-after after-50px pb-3 mb-3">{{ trans('solutions/byField/real_estate.solutionclassificationbasetitle') }}</h3>                       
                      </div>
                    </div>
            ...
            <div class="col-lg-12 col-xl-12">
                ...
                <h4 class="h4 mb-3">{{ trans('solutions/byField/real_estate.solutionclassificationone') }}</h4>
                <p class="lead mb-3"><?php $str = htmlspecialchars_decode(trans('solutions/byField/real_estate.solutionclassificationonefeatures'));
                                          echo $str; ?></p>
                  <h4 class="h4 mb-3">{{ trans('solutions/byField/real_estate.solutionclassificationtwo') }}</h4>
                <p class="lead mb-3"><?php $str = htmlspecialchars_decode(trans('solutions/byField/real_estate.solutionclassificationtwofeatures'));
                                          echo $str; ?></p>
                <h4 class="h4 mb-3">{{ trans('solutions/byField/real_estate.solutionclassificationthree') }}</h4>
                <p class="lead mb-3"><?php $str = htmlspecialchars_decode(trans('solutions/byField/real_estate.solutionclassificationthreefeatures'));
                                          echo $str; ?></p>                          
            </div>  
        </div>    
