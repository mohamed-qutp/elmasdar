...
<section id="services" class="services bg-gray-100">
    <div class="container vimeo-wrapper" data-aos="fade-up">       
        <div class="row  justify-content-center section-heading">
                        ...
                        <h3 data-aos="fade-up" class="bg-primary-after after-50px pb-3 mb-3">{{ trans('solutions/byCompanyDepartment/projects_management_and_workflow.solutionadvantagesbasetitle') }}</h3>                       
                      </div>
                    </div>
        <div class="row gy-5">
