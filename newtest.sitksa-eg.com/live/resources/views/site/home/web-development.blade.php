@if(app()->getLocale() == 'ar')
        ...
        <div class="container position-relative wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInUp;">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <h2 class="text-white h1 mb-4">تطوير مواقع الويب</h2>
                    <ol class="breadcrumb breadcrumb-light justify-content-center">
                        <li class="breadcrumb-item"><a href="/">الرئيسية</a></li>
                        <li class="breadcrumb-item active">تطوير مواقع الويب</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="row  justify-content-center">
                        ...
                        <h3 data-aos="fade-up"  class="bg-primary-after after-50px pb-3 mb-3"> {{ trans('services/web_development.servicetitle') }} </h3>                     
                      </div>
                    </div>
      <div class="row">      
        <div class="col-lg-6 d-flex flex-column justify-content-center fadeInUp" data-wow-duration="0.5s" style="visibility: visible; animation-duration: 0.5s; animation-name: fadeInUp;">        
          <h2 data-aos="fade-up" data-aos-delay="400" class="text-jsutify"> {{ trans('services/web_development.servicedescription') }}</h2>
    ...
    <section class="bg-gray-100">
        ...
        <div class="row  justify-content-center section-heading">
                        <div class="col-lg-8 col-xl-7 text-center wow fadeInUp" data-wow-duration="0.5s" style="visibility: visible; animation-duration: 0.5s; animation-name: fadeInUp;">
                        <h3 data-aos="fade-up"  class="bg-primary-after after-50px pb-3 mb-3">{{ trans('services/web_development.findoutaboutourservicestitle') }} </h3>
            ...
            <div class="col-lg-12 col-xl-12">               
                <p class="lead m-0"><?php $str = htmlspecialchars_decode(trans('services/web_development.findoutaboutourservices'));
                                          echo $str; ?></p>
            </div>
        </div>
</div>
...
@include('site.layouts_ar.ask-for-quotation')  
    ...
    @else
        ...
        <div class="container position-relative wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInUp;">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <h2 class="text-white h1 mb-4">Web Development</h2>
                    <ol class="breadcrumb breadcrumb-light justify-content-center">
    ...
    <section class="bg-gray-100">
        ...
        <div class="row  justify-content-center section-heading">
            ...
            <div class="row wow fadeInUp" data-wow-duration="0.5s" style="visibility: visible; animation-duration: 0.5s; animation-name: fadeInUp;">
            <div class="col-lg-12 col-xl-12">
                <!-- <h3 class="h1 mb-3">{{ trans('services/web_development.findoutaboutourservicestitle') }}</h3> -->
                <p class="lead m-0"><?php $str = htmlspecialchars_decode(trans('services/web_development.findoutaboutourservices'));
                                          echo $str; ?></p>
            </div>
        </div>
