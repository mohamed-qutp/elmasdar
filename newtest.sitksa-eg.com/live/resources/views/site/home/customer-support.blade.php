@if(app()->getLocale() == 'ar')
        ...
        <div class="container position-relative wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInUp;">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <h2 class="text-white h1 mb-4">{{ trans('services/technical_support.servicetitle') }}</h2>
                    <ol class="breadcrumb breadcrumb-light justify-content-center">
                        <li class="breadcrumb-item"><a href="/">الرئيسية</a></li>
                        <li class="breadcrumb-item active">{{ trans('services/technical_support.servicetitle') }}</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section  id="hero" class="basic-2 d-flex align-items-center  bg-gray-100 header-blur-light">
    <div class="container">
    <div class="row  justify-content-center">
                        ...
                        <h3 data-aos="fade-up"  class="bg-primary-after after-50px pb-3 mb-3"> {{ trans('services/technical_support.servicetitle') }}</h3>
      ...
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInUp;">
          ...
          <h2 data-aos="fade-up" data-aos-delay="400" class="text-jsutify"> {{ trans('services/technical_support.servicedescription') }}</h2>
