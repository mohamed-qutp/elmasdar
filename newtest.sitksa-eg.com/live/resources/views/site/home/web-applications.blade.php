@if(app()->getLocale() == 'ar')
    ...
    <div class="row  justify-content-center">
                        ...
                        <h3 data-aos="fade-up"  class="bg-primary-after after-50px pb-3 mb-3"> {{ trans('services/web_applications.servicetitle') }}</h3>                     
                      </div>
                    </div>
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInUp;">          
          <h2 data-aos="fade-up" data-aos-delay="400" class="text-jsutify"> {{ trans('services/web_applications.servicedescription') }}</h2>
  ...
  <section id="clients" class="clients bg-gray-100 header-blur-light">
      ...
      <div class="row  justify-content-center">
                        <div class="col-lg-8 col-xl-7 text-center wow fadeInUp" data-wow-duration="0.5s" style="visibility: visible; animation-duration: 0.5s; animation-name: fadeInUp;">
                        <h3 data-aos="fade-up"  class="bg-primary-after after-50px pb-3 mb-3"> {{ trans('services/web_applications.logostitle') }}</h3>                     
                      </div>
                    </div>
        <div class="row">
