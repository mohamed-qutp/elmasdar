        ...
        <div class="container position-relative wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInUp;">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <h2 class="text-white h1 mb-4">{{ trans('solutions/byField/restaurants_and_catering.solutiontitle') }}</h2>
                    <ol class="breadcrumb breadcrumb-light justify-content-center">
                        <li class="breadcrumb-item"><a href="/">الرئيسية</a></li>
                        <li class="breadcrumb-item active">{{ trans('solutions/byField/restaurants_and_catering.solutiontitle') }}</li>
                    </ol>
                </div>
            </div>
        </div>
...
<section class="section bg-gray-100">
    <div class="container-fluid">
        ...
        <div class="col-lg-8 col-xl-6">
            <h5 class="bg-primary-after after-50px pb-3 mb-3">{{ trans('solutions/byField/restaurants_and_catering.solutionclassificationbasetitle') }} </h5>
    ...
    <div class="tab-style-4 mt-3">
        ...
        <li class="nav-item" role="presentation">
            <a href="#tab3_sec1_03" data-bs-toggle="tab" class="active" aria-selected="false" role="tab" tabindex="-1"><div class="tb-icon"><i class="bi bi-chat"></i></div><span>{{ trans('solutions/byField/restaurants_and_catering.solutionclassificationone') }}</span></a>
        </li>
        <li class="nav-item" role="presentation">
            <a href="#tab3_sec2_03" data-bs-toggle="tab" aria-selected="false" role="tab" class="" tabindex="-1"><div class="tb-icon"><i class="bi bi-tools"></i></div><span>{{ trans('solutions/byField/restaurants_and_catering.solutionclassificationtwo') }}</span></a>
        </li>
        <li class="nav-item" role="presentation">
            <a href="#tab3_sec3_03" data-bs-toggle="tab" aria-selected="true" role="tab" class=""><div class="tb-icon"><i class="bi bi-megaphone"></i></div><span>{{ trans('solutions/byField/restaurants_and_catering.solutionclassificationthree') }}</span></a>
        </li>
    </ul>
    ...
    <div class="container-sty">
        <div class="row align-items-center gy-4 pt-5">
            <div class="col-lg-5 pe-xl-8">
                ...
                <p class="lead mb-5" style="margin-left: 80px;"><?php $str = htmlspecialchars_decode(trans('solutions/byField/restaurants_and_catering.solutionclassificationonefeatures'));
                                          echo $str; ?></p>
        ...
        <div class="container-sty">
            <div class="row align-items-center gy-4 pt-5 flex-row-reverse">
                <div class="col-lg-5 ps-xl-8">
                    <div class="h2 mb-3" style="margin-left: 80px;">Make smarter business decisions with data analysis</div>
                    <p class="lead mb-5" style="margin-left: 80px;"></p>
                ...
                <div class="container-sty">
                    <div class="row align-items-center gy-4 pt-5">
                        <div class="col-lg-5 pe-xl-8">
                            <div class="h2 mb-3" style="margin-left: 80px;">Make smarter business decisions with data analysis</div>
                        <p class="lead mb-5" style="margin-left: 80px;"><?php $str = htmlspecialchars_decode(trans('solutions/byField/restaurants_and_catering.solutionclassificationthreefeatures'));
                                          echo $str; ?></p>
