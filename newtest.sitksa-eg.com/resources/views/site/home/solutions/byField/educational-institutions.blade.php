        ...
        <div class="container position-relative wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInUp;">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <h2 class="text-white h1 mb-4">{{ trans('solutions/byField/educational_institutions.solutiontitle') }}</h2>
                    <ol class="breadcrumb breadcrumb-light justify-content-center">
                        <li class="breadcrumb-item"><a href="/">الرئيسية</a></li>
                        <li class="breadcrumb-item active">{{ trans('solutions/byField/educational_institutions.solutiontitle') }}</li>
                    </ol>
                </div>
            </div>
        </div>
...
<section class="section bg-gray-100">
    <div class="container-fluid">
        ...
        <div class="col-lg-8 col-xl-6">
            <h5 class="bg-primary-after after-50px pb-3 mb-3">{{ trans('solutions/byField/educational_institutions.solutionclassificationbasetitle') }}</h5>
    ...
    <div class="container-sty">
        <div class="row align-items-center gy-4 pt-5">
            <div class="col-lg-5 pe-xl-8">
                ...
                <p class="lead mb-5"><?php $str = htmlspecialchars_decode(trans('solutions/byField/educational_institutions.solutionclassificationonefeatures'));
                                          echo $str; ?></p>
    ...
    <div class="container-sty">
        <div class="row align-items-center gy-4 pt-5">
            <div class="col-lg-5 pe-xl-8">
                ...
                <p class="lead mb-5" style="margin-left: 80px;"><?php $str = htmlspecialchars_decode(trans('solutions/byField/educational_institutions.solutionclassificationonefeatures'));
                                          echo $str; ?></p>
