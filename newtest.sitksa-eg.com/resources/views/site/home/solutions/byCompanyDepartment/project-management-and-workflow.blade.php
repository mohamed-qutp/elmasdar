        ...
        <div class="container position-relative wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInUp;">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <h2 class="text-white h1 mb-4">{{ trans('solutions/byCompanyDepartment/projects_management_and_workflow.solutiontitle') }}</h2>
                    <ol class="breadcrumb breadcrumb-light justify-content-center">
                        <li class="breadcrumb-item"><a href="/">الرئيسية</a></li>
                        <li class="breadcrumb-item active">{{ trans('solutions/byCompanyDepartment/projects_management_and_workflow.solutiontitle') }}</li>
                    </ol>
                </div>
            </div>
        </div>
...
<section id="services" class="section services bg-gray-100">
    <div class="container vimeo-wrapper" data-aos="fade-up">       
        <div class="row  justify-content-center section-heading">
                        ...
                        <h5 data-aos="fade-up" class="bg-primary-after after-50px pb-3 mb-3">{{ trans('solutions/byCompanyDepartment/projects_management_and_workflow.solutionadvantagesbasetitle') }}</h5>                       
                      </div>
                    </div>
        <div class="row gy-5">
                ...
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <a href=" " class="stretched-link">
                            <h3><p  class="lead m-0">{{trans('solutions/byCompanyDepartment/projects_management_and_workflow.solutionadvantage1')}}</p></h3>
                        </a>
            ...
            <div id="solution" class="col-xl-3 col-md-6 wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInRight;">
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <a href=" " class="stretched-link">
                            <h3><p  class="lead m-0">{{trans('solutions/byCompanyDepartment/projects_management_and_workflow.solutionadvantage2')}}</p></h3>
                        </a>
                    </div>
                </div>
            </div><!-- End Service Item -->
            ...
            <div id="solution" class="col-xl-3 col-md-6 wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInRight;">
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <a href=" " class="stretched-link">
                            <h3><p  class="lead m-0">{{trans('solutions/byCompanyDepartment/projects_management_and_workflow.solutionadvantage3')}}</p></h3>
                        </a>
            ...
            <div id="solution" class="col-xl-3 col-md-6 wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInRight;">
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <a href=" " class="stretched-link">
                            <h3><p  class="lead m-0">{{trans('solutions/byCompanyDepartment/projects_management_and_workflow.solutionadvantage4')}}</p></h3>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div id="solution" class="col-xl-3 col-md-6 wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInRight;">
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <a href="" class="stretched-link">
                            <h3><p  class="lead m-0">{{trans('solutions/byCompanyDepartment/projects_management_and_workflow.solutionadvantage5')}}</p></h3>
                        </a>
                        <a href="" class="stretched-link"></a>
                    </div>
                </div>
            ...
            <div id="solution" class="col-xl-3 col-md-6 wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInRight;">
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <a href=" " class="stretched-link">
                            <h3><p  class="lead m-0">{{trans('solutions/byCompanyDepartment/projects_management_and_workflow.solutionadvantage6')}}</p></h3>
                        </a>
                        <a href=" " class="stretched-link"></a>
                    </div>
                </div>
            ...
            <div id="solution" class="col-xl-3 col-md-6 wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInRight;">
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <a href="" class="stretched-link">
                            <h3><p  class="lead m-0">{{trans('solutions/byCompanyDepartment/projects_management_and_workflow.solutionadvantage7')}}</p></h3>
                        </a>
                        <a href="" class="stretched-link"></a>
                    </div>
                </div>
            ...
            <div id="solution" class="col-xl-3 col-md-6 wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInRight;">
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <a href="" class="stretched-link">
                            <h3><p  class="lead m-0">{{trans('solutions/byCompanyDepartment/projects_management_and_workflow.solutionadvantage8')}}</p></h3>
                        </a>
                        <a href="" class="stretched-link"></a>
                    </div>
                </div>
