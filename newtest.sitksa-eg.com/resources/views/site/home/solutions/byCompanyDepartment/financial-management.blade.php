@if(app()->getLocale() == 'ar')
        ...
        <div class="container position-relative wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInUp;">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <h2 class="text-white h1 mb-4">{{ trans('solutions/byCompanyDepartment/financial_management.solutiontitle') }}</h2>
                    <ol class="breadcrumb breadcrumb-light justify-content-center">
                        <li class="breadcrumb-item"><a href="/">الرئيسية</a></li>
                        <li class="breadcrumb-item active">{{ trans('solutions/byCompanyDepartment/financial_management.solutiontitle') }}</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container vimeo-wrapper" data-aos="fade-up">       
        <div class="row  justify-content-center section-heading">
                        ...
                        <h5 class="bg-primary-after after-50px pb-3 mb-3">{{ trans('solutions/byCompanyDepartment/financial_management.solutionadvantagesbasetitle') }}</h5>                       
                      </div>
                    </div>
        <div class="row gy-5">
            <div id="solution" class="col-xl-3 col-md-6 wow fadeInRight"  data-wow-duration="0.5s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.2s; animation-name: fadeInRight;">
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <a href=" " class="stretched-link">
                            <h3><p  class="lead m-0">{{trans('solutions/byCompanyDepartment/financial_management.solutionadvantage1')}}</p></h3>
                        </a>
            ...
            <div id="solution" class="col-xl-3 col-md-6 wow fadeInRight"  data-wow-duration="0.5s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.2s; animation-name: fadeInRight;">
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <a href=" " class="stretched-link">
                            <h3><p  class="lead m-0">{{trans('solutions/byCompanyDepartment/financial_management.solutionadvantage2')}}</p></h3>
                        </a>
                    </div>
                </div>
            </div><!-- End Service Item -->
            ...
            <div id="solution" class="col-xl-3 col-md-6 wow fadeInRight"  data-wow-duration="0.5s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.2s; animation-name: fadeInRight;">
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <a href=" " class="stretched-link">
                            <h3><p  class="lead m-0">{{trans('solutions/byCompanyDepartment/financial_management.solutionadvantage3')}}</p></h3>
                        </a>
            ...
            <div id="solution" class="col-xl-3 col-md-6 wow fadeInRight"  data-wow-duration="0.5s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.2s; animation-name: fadeInRight;">
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <a href=" " class="stretched-link">
                            <h3><p  class="lead m-0">{{trans('solutions/byCompanyDepartment/financial_management.solutionadvantage4')}}</p></h3>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div id="solution" class="col-xl-3 col-md-6 wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.2s; animation-name: fadeInRight;">
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <a href="" class="stretched-link">
                            <h3><p  class="lead m-0">{{trans('solutions/byCompanyDepartment/financial_management.solutionadvantage5')}}</p></h3>
                        </a>
                        <a href="" class="stretched-link"></a>
                    </div>
                </div>
            ...
            <div id="solution" class="col-xl-3 col-md-6 wow fadeInRight"  data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInRight;">
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <a href=" " class="stretched-link">
                            <h3><p  class="lead m-0">{{trans('solutions/byCompanyDepartment/financial_management.solutionadvantage6')}}</p></h3>
                        </a>
                        <a href=" " class="stretched-link"></a>
                    </div>
                </div>
            ...
            <div id="solution" class="col-xl-3 col-md-6 wow fadeInRight"  data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInRight;">
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <a href="" class="stretched-link">
                            <h3><p  class="lead m-0">{{trans('solutions/byCompanyDepartment/financial_management.solutionadvantage7')}}</p></h3>
                        </a>
                        <a href="" class="stretched-link"></a>
                    </div>
                </div>
            ...
            <div id="solution" class="col-xl-3 col-md-6 wow fadeInRight"  data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInRight;">
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <a href="" class="stretched-link">
                            <h3><p  class="lead m-0">{{trans('solutions/byCompanyDepartment/financial_management.solutionadvantage8')}}</p></h3>
                        </a>
                        <a href="" class="stretched-link"></a>
                    </div>
                </div>
            ...
            <div id="solution" class="col-xl-3 col-md-6 wow fadeInRight"  data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInRight;">
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <a href="" class="stretched-link">
                            <h3><p  class="lead m-0">{{trans('solutions/byCompanyDepartment/financial_management.solutionadvantage9')}}</p></h3>
                        </a>
                        <a href="" class="stretched-link"></a>
                    </div>
                </div>
            ...
            <div id="solution" class="col-xl-3 col-md-6 wow fadeInRight"  data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInRight;">
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <a href="" class="stretched-link">
                            <h3><p  class="lead m-0">{{trans('solutions/byCompanyDepartment/financial_management.solutionadvantage10')}}</p></h3>
                        </a>
                        <a href="" class="stretched-link"></a>
                    </div>
                </div>
            ...
            <div id="solution" class="col-xl-3 col-md-6 wow fadeInRight"  data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInRight;">
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <a href="" class="stretched-link">
                            <h3><p  class="lead m-0">{{trans('solutions/byCompanyDepartment/financial_management.solutionadvantage11')}}</p></h3>
                        </a>
                        <a href="" class="stretched-link"></a>
                    </div>
                </div>
...
@include('site.layouts_ar.ask-for-quotation')  
    ...
    <div class="container vimeo-wrapper" data-aos="fade-up">       
        ...
        <div class="row gy-5">
            <div id="solution" class="col-xl-3 col-md-6 wow fadeInLeft"  data-wow-duration="0.5s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.2s; animation-name: fadeInLeft;">
                <div class="service-item">
                    <div class="img">
                        <img src="https://alsaifco-ksa.com/Dashboard/assets/Front/assets/img/solutions/%D8%A7%D9%84%D8%B4%D8%A8%D9%83%D8%A7%D8%AA%20%D8%A7%D9%84%D9%84%D8%A7%D8%B3%D9%84%D9%83%D9%8A%D8%A9.png" class="img-fluid" alt="">
                    </div>
