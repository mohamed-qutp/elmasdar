@if(app()->getLocale() == 'ar')
    ...
    <div class="row  justify-content-center">
                        ...
                        <h5 data-aos="fade-up"  class="bg-primary-after after-50px pb-3 mb-3"> {{ trans('services/cyber_security.servicetitle') }}</h5>                     
                      </div>
                    </div>
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInUp;">          
          <h6 data-aos="fade-up" data-aos-delay="400" class="text-jsutify"> {{ trans('services/cyber_security.servicedescription') }}</h6>
