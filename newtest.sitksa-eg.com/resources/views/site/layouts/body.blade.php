...
<!--    </video>    -->
<!--</div> -->-->
<!--<section id="hero1" class="section hero1">-->
...
<!--            <a href="https://www.youtube.com/watch?v=5KygwcZ545U&amp;ab_channel=JonathanMickelson" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Watch-->
<!--                Video</span></a>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
...
<video id="back" src=" {{asset('assets/home.mp4')}}" loop autoplay muted playsinline style="width:-moz-available;"></video>
 <span class="main-text-1">
   ...
   <span class="main-text-7">
    ...
    <!--<video src=" {{asset('assets/home.mp4')}}" loop autoplay muted playsinline style="width:-moz-available;"></video>-->
...
<section class="section" id="three" style="background-image: url('/assets/images/background1.jpg')">
  ...
  <div class="swiper swiper-container swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden" data-swiper-options="{
                                ...
                                <div class="card card-body"><a href="#"><img src="./assets/images/clients/1640774095.edu.png" title="" alt=""></a></div>
                ...
                <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span> 
                              ...
                              <section class="section" style="background-image: url('/assets/images/map-with-patern-2.png');padding-top: 3.25rem;background-size:100% 100%;">
                                     <div class="container">
                                         <div class="row">
                                                ...
                                                <div class="row section-heading justify-content-center text-center wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.1s; animation-name: fadeInUp;"><div class="col-lg-8 col-xl-6"><h6 class="bg-primary-after after-50px pb-3 mb-3" style="font-size: 18px;">{{ trans('home.ourlocations') }}</h6></div></div>
                                                 <form>
                                                         ...
                                                         <div class="form-group row">
                                                             <label for="inputEmail3" class="col-sm-2 col-form-label label-txt">Madinah</label>
                                                             <div class="col-sm-10">
                                                              <input type="text" class="form-control input-form-txt">
                                                              </div>
                                                          </div>
                                                      <div class="form-group row">
                                                             <label for="inputEmail3" class="col-sm-2 col-form-label label-txt">Riyadh</label>
                                                             <div class="col-sm-10">
                                                              <input type="text" class="form-control input-form-txt">
                                                              </div>
                                                          </div>
                                                          <div class="form-group row">
                                                             <label for="inputEmail3" class="col-sm-2 col-form-label label-txt">Dammam</label>
                                                             <div class="col-sm-10">
                                                              <input type="text" class="form-control input-form-txt">
                                                              </div>
                                                          </div>
                                                          <div class="form-group row">
                                                             <label for="inputEmail3" class="col-sm-2 col-form-label label-txt">Jeddah</label>
                                                             <div class="col-sm-10">
                                                              <input type="text" class="form-control input-form-txt">
                                                              </div>
                                                          </div>
