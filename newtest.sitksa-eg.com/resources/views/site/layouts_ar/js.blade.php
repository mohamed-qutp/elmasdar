...
var serviceContent = {
    1:'العمود الفقري لشركات متعددة المهام والأقسام الإدارية لأنها تعزز أتمتة عمليات كافة الأعمال الأساسية وإدارتها لتحقيق تخطيط جميع موارد المؤسسات وتدفق البيانات بين المهام التجارية للشركة. يبسط برامج تخطيط موارد المؤسسات ERP ويربط العمليات والبيانات عبر المؤسسة ببعضها بحيث تكون الحسابات وسلسلة التوريد والعمليات والتجارة وإعداد التقارير والتصنيع وأنشطة الموارد البشرية على منصة واحدة لمرونة التعديل وتلبية احتياجات العملاء على حده.',
    2:'هو نظام يستخدم لإتمام عمليات البيع من مبيعات ومدفوعات وإدارة المخزون بشكل منظم وفعّال حيث يتمثل هدفه الرئيسي في تسهيل تجربة العملاء وتحسين إدارة الأعمال. يستخدم هذا النظام في مختلف الصناعات بما في ذلك التجزئة، المطاعم، الفنادق، الخدمات وهكذا... يسهل نظام نقاط البيع عمليات الدفع والإتمام مما يقلل أوقات الانتظار للعملاء ويساهم في تجنب الأخطاء البشرية في إدخال البيانات والعمليات المالية، كما أنه يُيسر مراقبة مستويات المخزون وإعادة الطلب ويساعد في توفير تقارير مفصّلة حول المبيعات والأصناف والعملاء.',
    ...
    4:'هي أنظمة برمجية مصممة لتعمل على أنظمة تشغيل الهواتف الذكية مثل iOS وأندرويد وغيرها. تتنوع هذه التطبيقات في مجموعة واسعة من المجالات والاستخدامات، كما أنها توفر واجهة تفاعلية تسمح للمستخدمين للوصول إلى محتوى أو أداء وظائف معينة بسهولة من خلال الهواتف الجوال. يشمل تطوير تطبيقات هواتف الجوال مراحل مماثلة لتطوير مواقع الويب، مثل التخطيط والتصميم والبرمجة واختبار الجودة. ولكن هناك اهتمام خاص بتجربة المستخدم عبر الأجهزة المحمولة بما في ذلك استجابة التطبيق وتوافقه مع مختلف حجم الشاشات والأجهزة.',
    5:'هي برمجيات تعمل على الإنترنت ولكنها من نوع مختلف حيث تُمكن المستخدمين من الوصول إليها دون عملية التنزيل والتثبيت لبرامج إضافية. هذه التطبيقات تتواجد على الخوادم البعيدة لتقديم واجهة مستخدم تفاعلية يمكن الوصول إليها، كما تعمل على تبادل المعلومات وتقديم الخدمات عن بُعد. تُعتبر هذه التطبيقات جزءاً مهماً من الحياة اليومية للمستخدم، لأنها تغطي مجموعة متنوعة من الصناعات مثل التسوق عبر الإنترنت، وإدارة المشاريع، وتوفير الخدمات المصرفية عبر الإنترنت وتقديم المحتوى التعليمي، والتواصل الاجتماعي.',
    6:'الأمن السيبراني أمر حيوي في عصرنا الحديث نظراً لتطورات الحالية بخصوص اعتمدنا الكامل على التكنولوجيا والاتصالات الرقمية في مختلف جوانب الحياة. تهدف هذه الإجراءات إلى الحفاظ على سلامة وخصوصية البيانات وضمان استمرارية العمليات الأساسية للأفراد والشركات والمؤسسات. هي مجموعة من الإجراءات التقنية التي تهدف إلى حماية أنظمة الحاسوب والشبكات والبيانات من القرصنة الإلكترونية والهجمات السيبرانية. يشمل الأمن السيبراني العديد من التحديات والمخاطر مثل الاحتيال الإلكتروني وسرقة الهوية والتهديدات الناشئة.',
    7:'استراتيجيات وأدوات غرضها بالأساس تسويقي، تُستخدم عبر الإنترنت لترويج المنتجات أو الخدمات أو العلامات التجارية. يعتمد التسويق الرقمي على استخدام الوسائل الإلكترونية والمنصات الرقمية مع العملاء المحتملين والحاليين. نحن في المصدر لتقنية المعلومات نقدم حلولاً ذكية لعملائنا ونعزز الحضور في السوق التجاري سواء المحلي أو العالمي بإنشاء محتوى ذو قيمة مضافة يجعل الجمهور متابع ومخلص لك ولعلامتك التجارية مما يوصلنا بالنهاية إلى زيادة المبيعات باستخدام التكنولوجيا الرقمية والوسائل الإلكترونية.',
    8:'في المصدر لتقنية المعلومات نقدم مجموعة من الخدمات والإجراءات التي تهدف إلى مساعدة العملاء في حل مشاكلهم التقنية واستفساراتهم المتعلقة بالأنظمة الرقمية. يتم تقديم خدمات الدعم التقني عبر وسائل ومنصات متعددة لنكون بجانبك وقتما تحتاجنا. الدعم الفني يوفر توجيهاً وتدريباً للمستخدمين لمساعدتهم في فهم كيفية استخدام التكنولوجيا بشكل أفضل وبشكل أكثر فعالية، كما يشمل الدعم التقني صيانة الأنظمة بما في ذلك تثبيت التصحيحات والتحديثات الأمنية وترقيات البرامج مما يساعد في توفير تجربة إيجابية للعملاء وضمان عمل الأنظمة بشكل صحيح وفعال.'
};  
